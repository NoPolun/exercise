...
- (void)layoutButtonWithEdgeInsetsStyle:(MKButtonEdgeInsetsStyle)style
                        imageTitleSpace:(CGFloat)space fontsize:(CGFloat)fontsize color:(UIColor *)titleColor
{
//    self.backgroundColor = [UIColor cyanColor];
    ...
    switch (style) {
        case MKButtonEdgeInsetsStyleTop:
        {
            ...
            labelEdgeInsets = UIEdgeInsetsMake(0, -imageWith-10, -imageHeight-space/2.0, -10);
        }
            break;
